...
class DataProviderTests: XCTestCase {
    ...
    func testCellForRowAtIndexPathDequeuesCellFromTableView() {
        ...
        let mockTableView = MockTableView.mockTableViewDataSource(withDataSource: sut)
...
extension DataProviderTests {
    ...
    class MockTableView: UITableView {
        ...
        static func mockTableViewDataSource(withDataSource dataSource: UITableViewDataSource) -> MockTableView {
